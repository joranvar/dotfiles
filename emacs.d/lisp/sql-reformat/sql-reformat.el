...
first line."
  ...
  (pcase ast
    ...
    (`(pred ,predexpr ,predop, pred) (s-concat (sql-astts predexpr) (sql-newline) (sql-astts predop) (sql-astts pred)))
    (`(pred . ,predexpr)        (sql-astts predexpr))
    (`(predexpr ,not ,expr1 ,cmp ,expr2)
     (s-concat (unless (string= "" not) "NOT ") (sql-astts expr1) " " (sql-astts cmp) " " (sql-astts expr2)))
    (`(predop and . ,_)         "       AND ")
    (`(predop or . ,_)          "    OR ")
    (`(cmp . ,cmp)              cmp)
